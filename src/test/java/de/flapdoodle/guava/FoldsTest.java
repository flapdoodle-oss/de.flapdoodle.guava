...
import de.flapdoodle.guava.Folds.ImmutableListFold;
...
public class FoldsTest {
	...
	public void enumSetFoldUseCases() {
		foldUseCases(new Folds.EnumSetFold<DummyEnum>(), enumsetTestSet());
	}
	...
	static FoldTestset<String, ImmutableList<String>> listTestSet() {
		...
		return new FoldTestset<String, ImmutableList<String>>(empty, colliding, 
				TestPair.of(ImmutableList.of("foo"), Lists.<String>newArrayList(), ImmutableList.of("foo")),
				TestPair.of(ImmutableList.<String>of(), Lists.newArrayList("bar"), ImmutableList.of("bar")),
				TestPair.of(ImmutableList.of("foo"), Lists.newArrayList("bar"), ImmutableList.of("foo", "bar"))
				);
	}
	...
	static FoldTestset<String, ImmutableSet<String>> setTestSet() {
		...
		Optional<TestPair<String, ImmutableSet<String>>> colliding = Optional.<TestPair<String, ImmutableSet<String>>> of(
				TestPair.of(ImmutableSet.of("foo"), Sets.newHashSet("foo"), ImmutableSet.of("foo"))
				);

		return new FoldTestset<String, ImmutableSet<String>>(empty, colliding, 
				TestPair.of(ImmutableSet.of("foo"), Sets.<String>newHashSet(), ImmutableSet.of("foo")),
				TestPair.of(ImmutableSet.<String>of(), Sets.newHashSet("bar"), ImmutableSet.of("bar")),
				TestPair.of(ImmutableSet.of("foo"), Sets.newHashSet("bar"), ImmutableSet.of("foo", "bar"))
				);
	}
	...
	static FoldTestset<DummyEnum, EnumSet<DummyEnum>> enumsetTestSet() {
		...
		Optional<TestPair<DummyEnum, EnumSet<DummyEnum>>> colliding = Optional.<TestPair<DummyEnum, EnumSet<DummyEnum>>> of(
				TestPair.of(EnumSet.of(DummyEnum.A,DummyEnum.B), Sets.newHashSet(DummyEnum.C,DummyEnum.B), EnumSet.of(DummyEnum.B))
				);

		return new FoldTestset<DummyEnum, EnumSet<DummyEnum>>(empty, colliding, 
				TestPair.of(EnumSet.of(DummyEnum.A), Sets.<DummyEnum>newHashSet(), EnumSet.of(DummyEnum.A)),
				TestPair.of(EnumSet.noneOf(DummyEnum.class), Sets.newHashSet(DummyEnum.B), EnumSet.of(DummyEnum.B)),
				TestPair.of(EnumSet.of(DummyEnum.A), Sets.newHashSet(DummyEnum.B), EnumSet.of(DummyEnum.A, DummyEnum.B))
				);
	}
